...
echo ""
echo "Flash:"
echo "  esptool --chip esp32s3 -p /dev/cu.usbmodem101 -b 460800 --before default-reset --after no-reset \\"
echo "    write-flash -z --flash-mode dio --flash-freq 80m 0x0 build-out/firmware.bin"
echo "  esptool --chip esp32s3 -p /dev/cu.usbmodem101 --before no-reset --after watchdog-reset run"
